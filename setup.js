jQuery(function(){
	...
	jQuery(document).on('click', '[class^="button spambye2DelColumn"]', function()
	{
	...
	jQuery(document).on('click', '[class^="button spambye2UpColumn"]', function()
	{
		var myObj  = jQuery(this).parent().parent();
		var myObj2 = myObj.next();
	...
	jQuery(document).on('click', '[class^="button spambye2DownColumn"]', function()
	{
		var myObj  = jQuery(this).parent().parent();
		var myObj2 = myObj.next();
	...
	jQuery(document).on('change', '[class^="postform spambye2ChangeColumn"]', function()
	{
		var myObj   = jQuery(this).parent().parent();
