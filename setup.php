...
?>
	...
	<div class="wrap">
		<h2>SPAM-BYEBYE設定</h2>
		<h3 id="spambye2result" style="color:#ff0000;"><?php echo htmlspecialchars($_POST['_SB2_RESULT']); ?></h3>
		<h3>基本設定</h3>

		<form method="post" action="admin.php?page=spam-byebye">
		<input type="hidden" name="spam-byebye_update" value="1" />
		<input type="hidden" name="SB2_ENTRY_OBJECT[]" value="<?php echo htmlspecialchars($_POST['SB2_ENTRY_OBJECT'][0]); ?>" id="spambye2ObjectNum" />
		...
		<tr style="background-color:#f9f9f9;">
			<td style="color:red;border-top:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_SPAM_LEVEL']['error']); ?></td>
		</tr>
		...
		<tr style="background-color:#ececec;">
			<td style="color:red;border-top:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_SPAM_ACTION']['error']); ?></td>
		</tr>
		<tr style="background-color:#f9f9f9;">
		...
		<tr style="background-color:#f9f9f9;">
			<td style="color:red;border-top:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_SPAM_MESSAGE']['error']); ?></td>
		</tr>
		<tr style="background-color:#ececec;">
		...
		<tr style="background-color:#ececec;">
			<td style="color:red;border-top:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_SPAM_REDIRECT']['error']); ?></td>
		</tr>
		<tr style="background-color:#f9f9f9;">
		...
		<tr style="background-color:#f9f9f9;">
			<td style="color:red;border-top:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_DNSBL_HOSTS']['error']); ?></td>
		</tr>
		<tr style="background-color:#ececec;">
		...
		<tr style="background-color:#ececec;">
			<td style="color:red;border-top:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_URIBL_HOSTS']['error']); ?></td>
		</tr>
		<tr style="background-color:#f9f9f9;">
		...
		<tr style="background-color:#f9f9f9;">
			<td style="color:red;border-top:0;border-bottom:0;padding:0 10px;"><?php echo htmlspecialchars($_POST['SB2_WHITE_LISTS']['error']); ?></td>
		</tr>
		</tbody>
		</table>
		...
		<tr class="spambye2Column" style="background-color:<?php echo $bgcol ?>;">
			<td rowspan="2" style="border-right:1px solid #dfdfdf;white-space:nowrap;text-align:center;<?php echo htmlspecialchars($lastStyle); ?>"<?php if ($lastStyle) echo " class='spambye2LastColumn'"; ?>>
				<input type="button" class="button spambye2UpColumn" value="↑" />
				<input type="button" class="button spambye2DownColumn" value="↓" />
			</td>
			<td rowspan="2" style="border-right:1px solid #dfdfdf;<?php echo htmlspecialchars($lastStyle); ?>"<?php if ($lastStyle) echo " class='spambye2LastColumn'"; ?>>
		...
		<tr class="spambye2ErrorColumn" style="background-color:<?php echo $bgcol ?>;">
			<td colspan="2" style="color:red;border-top:0;padding:0 10px;<?php echo $lastStyle; ?>"<?php if ($lastStyle) echo " class='spambye2LastColumn'"; ?>><?php echo htmlspecialchars($_POST[$defName]['error']); ?></td>
		</tr>
		<?php
			}
		?>
